...
app.use(session({
  secret:'SomeSecret',
  saveUninitialized: false, // prevents browser from using empty sessions
  resave: false
}));

// initialize flash
app.use(flash());  // for maintaining messages for users while authenticating
...
// serialize and deserialize the User info (it's like an encryption and decryption process)
